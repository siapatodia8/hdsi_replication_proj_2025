    ...
    def test_answer_question_integration(self):
        ...
        mock_responses = [
            ...
            Mock(
                content=[
                    Mock(
                        text="This query searches for drugs that treat diseases whose "
                             "name contains 'hypertension' and returns the drug and "
                             "disease names (up to 10 results)."
                    )
                ]
            ),  # explain  <-- added for the new step
            Mock(
                content=[
                    Mock(text="Several drugs treat hypertension including AlphaCure.")
                ]
